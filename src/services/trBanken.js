...
export const TR_BANKEN_COMPLEET = [
  // ───────── PUBLIEKE BANKEN ─────────
  { id: 'ziraat',       naam: 'Ziraat Bankası',           categorie: 'publiek',     kleur: '#E30614', symbool: 'Z', code: 'TCZB', volgnr: 10 },
  ...
  { id: 'garanti',      naam: 'Garanti BBVA',             categorie: 'prive',       kleur: '#1B8B47', symbool: 'G',  code: 'TGBA', volgnr: 62 },
  ...
  { id: 'istpay',       naam: 'İstPay',                   categorie: 'wallet',      kleur: '#003D8F', symbool: 'İ',  code: 'ISPY', volgnr: null },
...
export const CATEGORIE_LABELS = {
  ...
  deelname:    { naam: 'Katılım banken',        volgorde: 4 },
