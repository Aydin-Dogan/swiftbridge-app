        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2 group">
            <Zap
              ...
              aria-hidden="true"
            />
            <span className="font-display text-[1.45rem] font-medium text-gray-900 tracking-[0.04em]">
              SwiftBridge
            </span>
          </a>

          <div className="hidden md:flex items-center gap-7 text-[0.7rem] font-medium uppercase tracking-[0.2em] text-gray-600">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="hidden sm:inline-flex text-[0.7rem] font-medium uppercase tracking-[0.2em] text-blue-600 hover:text-blue-700 px-3 py-2 transition"
            >
              {t('inloggen')}
            </button>
            <button
              onClick={() => navigate('/login?tab=register')}
              className="btn-inst px-5 py-2.5"
            >
